...
class DataSourceWidget(QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setObjectName("data_source")
        self._metadata = []
        self.master_df = None
    ...
    def init_ui(self):
        ...
        self.time_interval_combo.setObjectName("data_source.time_interval")
        ...
        instrument_group.setObjectName("data_source.instrument_selection")
        instrument_group_layout = QVBoxLayout(instrument_group)
        
        filter_layout = QHBoxLayout()
        self.search_filter = QLineEdit()
        self.search_filter.setObjectName("data_source.instrument_selection.search")
        self.search_filter.setPlaceholderText("Search Symbol...")
        self.sector_filter = QComboBox()
        self.sector_filter.setObjectName("data_source.instrument_selection.sector_filter")
        self.index_filter = QComboBox()
        self.index_filter.setObjectName("data_source.instrument_selection.index_filter")
        ...
        master_date_group.setObjectName("data_source.master_date_range")
        ...
        self.master_start_date.setObjectName("data_source.master_date_range.start_date")
        ...
        self.master_end_date.setObjectName("data_source.master_date_range.end_date")
        ...
        validation_group.setObjectName("data_source.validation_method")
        validation_group.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Maximum)
        validation_layout = QVBoxLayout(validation_group)
        self.split_method_combo = QComboBox()
        self.split_method_combo.setObjectName("data_source.validation_method.split_method")
    ...
    def _create_instrument_selection_ui(self):
        ...
        self.available_instruments_list.setObjectName("data_source.instrument_selection.available_list")
        ...
        self.add_button.setObjectName("data_source.instrument_selection.add_button")
        self.remove_button = QPushButton("<<")
        self.remove_button.setObjectName("data_source.instrument_selection.remove_button")
        self.add_all_button = QPushButton("All >>")
        self.add_all_button.setObjectName("data_source.instrument_selection.add_all_button")
        self.remove_all_button = QPushButton("<< All")
        self.remove_all_button.setObjectName("data_source.instrument_selection.remove_all_button")
        ...
        self.selected_instruments_list.setObjectName("data_source.instrument_selection.selected_list")
    ...
    def _create_date_range_widget(self):
        container = QWidget()
        container.setObjectName("data_source.validation_method.date_range_options")
        ...
        self.training_start_date.setObjectName("data_source.validation_method.date_range.training_start")
        ...
        self.training_end_date.setObjectName("data_source.validation_method.date_range.training_end")
        ...
        self.validation_start_date.setObjectName("data_source.validation_method.date_range.validation_start")
        ...
        self.validation_end_date.setObjectName("data_source.validation_method.date_range.validation_end")
    ...
    def _create_percent_split_widget(self):
        container = QWidget()
        container.setObjectName("data_source.validation_method.percentage_split_options")
        layout = QVBoxLayout(container)
        input_layout = QHBoxLayout()
        input_layout.addWidget(QLabel("Validation Percentage:"))
        self.validation_percent_spinbox = QSpinBox()
        self.validation_percent_spinbox.setObjectName("data_source.validation_method.percentage_split.validation_percentage")
    ...
    def _create_kfold_widget(self):
        container = QWidget()
        container.setObjectName("data_source.validation_method.kfold_options")
        layout = QHBoxLayout(container)
        layout.addWidget(QLabel("Number of Folds (K):"))
        self.k_folds_spinbox = QSpinBox()
        self.k_folds_spinbox.setObjectName("data_source.validation_method.kfold.k_folds")
